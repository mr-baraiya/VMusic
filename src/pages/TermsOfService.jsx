    ...
    <div className="min-h-screen bg-linear-to-b from-gray-900 via-gray-900 to-black pb-20">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <Section title="1. Acceptance of Terms" delay={0.1}>
          By accessing or using VMusic, you acknowledge that you have read, understood, and agree to
        ...
        <Section title="2. Use of the Service" delay={0.2}>
          <ul className="list-disc ml-6 space-y-2">
            ...
            <li>
              You may only use VMusic for lawful purposes and in compliance with applicable
              copyright laws.
            </li>
          </ul>
        </Section>
        ...
        <Section title="3. Google Login & YouTube API Usage" delay={0.3}>
          <p className="mb-3">
            When you sign in with Google, VMusic collects your name, email, and profile picture.
            This is used only to authenticate you and enhance your user experience.
          </p>
          <p className="mb-3">
        ...
        <Section title="4. Intellectual Property" delay={0.4}>
          All music on VMusic comes from licensed or open sources such as Jamendo API. You may not
          copy, download, or distribute content unless explicitly permitted.
        </Section>
        ...
        <Section title="6. Account Termination" delay={0.6}>
          We may suspend or terminate accounts that violate these Terms or engage in harmful
          behavior.
        </Section>

        <Section title="7. Updates to Terms" delay={0.7}>
          We may modify these Terms at any time. Updates will appear on this page with a revised
          date.
        </Section>
