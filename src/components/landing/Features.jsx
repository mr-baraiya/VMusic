...
const features = [
  {
    ...
    description: 'Instantly find any song, artist, or album from our massive library powered by Jamendo API.',
    gradient: 'from-blue-500 to-cyan-500',
  },
  {
    icon: Heart,
    title: 'Like & Save',
    description: 'Create custom playlists, save your favorite tracks, and organize your music library.',
    gradient: 'from-pink-500 to-rose-500',
  },
  {
    icon: Radio,
    title: 'Smart Radio',
    description: 'Discover new music with mood-based radio stations. Chill, Focus, Workout, and more.',
    gradient: 'from-purple-500 to-indigo-500',
  },
  {
    icon: Cloud,
    title: 'Cloud Sync',
    description: 'Access your playlists and favorites from any device. Everything syncs seamlessly.',
  ...
  },
  {
    ...
    description: 'No ads, no interruptions, no premium tiers. Just pure music streaming for everyone.',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Experience the future of independent music streaming with powerful features designed for music lovers.
          </p>
        </motion.div>
